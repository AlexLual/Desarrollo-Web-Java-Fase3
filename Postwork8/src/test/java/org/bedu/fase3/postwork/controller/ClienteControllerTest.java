...
public class ClienteControllerTest {
    ...
    void getCliente() throws Exception {
        ...
        given(clienteService.obtenCliente(anyLong())).willReturn(Optional.of(Cliente.builder()
            .Id(1L)
            .nombre("Nombre")
            .correoElectronico("cliente@contacto.com")
            .build()));
        ...
        mockMvc.perform(get("/cliente/1")
               ...
               .andExpect(jsonPath("$.correoElectronico", is("cliente@contacto.com")))
    ...
    void getClientes() throws Exception {
        ...
        List<Cliente> clientes = Arrays.asList(
                Cliente.builder()
                        ...
                        .numeroEmpleados(11)
                        .correoElectronico("contacto@cliente1.com")
                        .build(),

                Cliente.builder()
                        .Id(2L)
                        .nombre("Nombre 2")
                        .direccion("Direccion 2").numeroEmpleados(11)
                        .correoElectronico("contacto@cliente2.com")
                        .build(),
                ...
                Cliente.builder()
                        ...
                        .numeroEmpleados(11)
                        .correoElectronico("contacto@cliente3.com")
                        .build()
        );
        ...
        mockMvc.perform(get("/cliente")
                ...
                .andExpect(jsonPath("$[0].correoElectronico", is("contacto@cliente1.com")))
    ...
    void creaCliente() throws Exception {
        ...
        Cliente clienteRespuesta = Cliente.builder()
                                            .Id(1L)
                                            .nombre("Nombre")
                                            .direccion("Direccion")
                                            .numeroEmpleados(11)
